...
import article.domain.co.create_article.ArticleCreateCO;
import article.domain.co.delete_article.ArticleDeleteCO;
import article.domain.co.edit_article.ArticleEditCO;
import article.domain.co.publish_article.ArticlePublishCO;
...
public class ArticleManagementController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Void> createArticle(@RequestBody ArticleCreateCO co) {
    ...
    @PostMapping("/publish")
    @RequireAuthorization(policy = RequireAuthorization.AuthorizationPolicy.ROLE)
    public ResponseEntity<Void> publishArticle(@RequestBody ArticlePublishCO co) {
    ...
    @PostMapping("/delete")
    @RequireAuthorization(policy = RequireAuthorization.AuthorizationPolicy.ROLE)
    public ResponseEntity<Void> deleteArticle(@RequestBody ArticleDeleteCO co) {
    ...
    @PutMapping("/edit")
    @RequireAuthorization(policy = RequireAuthorization.AuthorizationPolicy.ROLE)
    public ResponseEntity<Void> editArticle(@RequestBody ArticleEditCO co) {
